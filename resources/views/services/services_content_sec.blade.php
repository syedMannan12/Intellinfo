<section class="industries_content_sec">
    <div class="container">
        <h2>Our Servies</h2>
        <p>Utilizing ten years of experience in various fields, Intelliinfotech is in a position to offer the full software development cycle as well as the following range of services</p>
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 mt-5">
                <div class="card our_industries_all_cards">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <img src="{{URL::asset('assets/images/home/business.jpg')}}"
                    ...
                    <div class="container mt-3">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php
                                $short_des= "Software solutions are an integral part of modern business operations. These are specialized programs or sets of instructions that are designed to perform specific tasks on computers or devices.";
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mt-5">
                <div class="card our_industries_all_cards">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <img src="{{URL::asset('assets/images/home/webSolutions.jpg')}}"
                                class="all_images" width="100%" height="200px" alt="">
                        </div>
                    </div>
                    <div class="container mt-3">
                        <div class="row">
                            <div class="col-lg-12">
                                <h5>Web solutions</h5>
                                <?php
                                $short_des= "Web solutions refer to a range of technologies, services, and tools used to develop, manage and maintain websites. As the importance of online presence grows, web solutions have become increasingly essential for businesses of all types and sizes.";
                                $short_des = mb_strimwidth($short_des, 0, 100, "....");
                            ?>
                                <p> {{$short_des}} </p>
                                <div class="text-end mb-3">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mt-5">
                <div class="card our_industries_all_cards">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <img src="{{URL::asset('assets/images/home/mobileSolutons.jpg')}}"
                                class="all_images" width="100%" height="200px" alt="">
                        </div>
                    </div>
                    <div class="container mt-3">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <?php
                                $short_des= "Mobile solutions refer to the set of tools, technologies, and services that enable businesses to effectively leverage mobile devices, such as smartphones and tablets,";
                                $short_des = mb_strimwidth($short_des, 0, 100, "....");
                            ?>
                                <p> {{$short_des}} </p>
                                <div class="text-end mb-3">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mt-5">
                <div class="card our_industries_all_cards">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <img src="{{URL::asset('assets/images/services/network.jpg')}}"
                                class="all_images" width="100%" height="200px" alt="">
                        </div>
                    </div>
                    <div class="container mt-3">
